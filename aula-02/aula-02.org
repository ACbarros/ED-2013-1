...
#+BEGIN_SRC lisp
  (loop for x from 1 to 100 collect (list x (< (fib2 x) (expt 2 (* x 0.694)))))
#+END_SRC

#+RESULTS[b9ed2fef31d1c4419ce48ba39acce042f9b96d4b]:
|   1 | t |
|   2 | t |
|   3 | t |
|   4 | t |
...
#+BEGIN_SRC lisp
  (loop for x from 1 to 100 collect (list x (< (fib2 x) (expt 2 (* x 0.68)))))
#+END_SRC
